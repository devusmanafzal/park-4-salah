...
const Donate = () => {
  return (
    <section className="container max-w-3xl py-16 sm:py-24">
      <p className="text-sm uppercase tracking-[0.18em] text-muted-foreground mb-4">Support the project</p>
      <h1 className="font-display text-4xl sm:text-5xl leading-[1.05]">Donate to keep Park for Salah running.</h1>
